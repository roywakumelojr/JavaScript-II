...
ticketPriceTotal = runners.reduce(function(totalDonations, runner) {
...
let contactInfo = [];
  runners.forEach(function(items){
    return contactInfo.push(`${items.first_name} ${items.last_name} ${items.email}`);
  });
console.log(contactInfo);

// Problem 2
let runnersSmallSizeShirt = runners.filter(function(items) {
